...
const Pot = ({ focused }: SettingsIconProps) => (
  <Svg width="30" height="30" viewBox="0 0 25 25">
    {focused ? (
      <>
        <Path
          fill={theme.colors.white}
          d="M3-952h18v9c0,0.833-0.291,1.542-0.875,2.125S18.834-940,18-940H6c-0.833,0-1.542-0.292-2.125-0.875
	...
	C9.479-956.904,9.717-957,10-957h4c0.283,0,0.521,0.096,0.713,0.288C14.904-956.521,15-956.283,15-956v1h6v2H3z"
        ...
        <Path
          fill={theme.colors.white}
          d="M3,8.5h18v9c0,0.834-0.291,1.541-0.875,2.125S18.834,20.5,18,20.5H6c-0.833,0-1.542-0.291-2.125-0.875
